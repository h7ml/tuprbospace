 ...
 * @Date: 2023-05-31 09:53:52
 * @LastEditors: h7ml <h7ml@qq.com>
 * @LastEditTime: 2023-05-31 22:23:18
 * @FilePath: \tuprbospace\packages\hooks\src\pages\dashboard\index.tsx
 * @Description:  https://juejin.cn/post/7233966272991264825
 * @github https://github.com/dbfu/fluxy-admin-web/blob/main/src/pages/dashboard/index.tsx
 *
        ...
        <Col className="w-[100%]" lg={24} xl={8}>
          <div className="dark:bg-[rgb(33,41,70)] bg-white h-[550px] rounded-md p-[24px] relative">
            ...
            <div className="dark:bg-[rgb(209,196,233)] bg-[rgb(237,231,246)] px-[16px] pt-[16px] mt-[24px] rounded-t-lg">
              ...
              <div className="mt-[10px] text-[rgb(66,66,66)]">{t('SwsawJhB' /* 20% 利润 */)}</div>
            </div>
